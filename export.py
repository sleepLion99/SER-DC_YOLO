...
def parse_opt():
    ...
    parser.add_argument('--weights', nargs='+', type=str, default=ROOT / 'others/normal_best.pt', help='model.pt path(s)')
    ...
    parser.add_argument('--iou-thres', type=float, default=0.3, help='TF.js NMS: IoU threshold')
    parser.add_argument('--conf-thres', type=float, default=0.6, help='TF.js NMS: confidence threshold')
